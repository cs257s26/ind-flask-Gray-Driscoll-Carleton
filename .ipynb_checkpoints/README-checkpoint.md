...
Then visit 
http://stearns.mathcs.carleton.edu:<port>/litGrowth/1946/1950/France
or 
http://stearns.mathcs.carleton.edu:5151/education/Ukraine/2020
Note that our database has plenty of holes, education is typically entered every five years, and many countries stopped recording literacy rates once they became increasingly close to 100%. These flask routes will show no data when the years fall in one of these dead zones. Both of the provided links will display data.
...
The second query, `education` seeks to help the user story of a student desiring to know the "average years of schooling in my country for any 5 years". The function finds the education metrics for any given place at a given time, which the student may then use to further develop their understanding of global education benchmarks.
